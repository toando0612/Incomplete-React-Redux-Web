...
function courses() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : ['WP', 'SADI'];
    var action = arguments[1];

    if (action.type == 'LIST_COURSE') return state;else if (action.type == 'ADD_COURSE') return [].concat(state, action.payload);else return state;
}

var centralState = (0, _redux.combineReducers)({
    students: students, courses: courses, editStudent: editStudent
});
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    null,
                    path.includes('about') ? _react2.default.createElement(About, null) : _react2.default.createElement(
                        'div',
                        null,
                        _react2.default.createElement(_Form2.default, { editStudent: this.props.editStudent, dispatch: this.props.dispatch }),
                        _react2.default.createElement(_List2.default, { students: this.props.students, dispatch: this.props.dispatch })
                    )
                )
            );
        }
...
function mapStateToProps(centralState) {
    return {
        ...
        editStudent: centralState.editStudent
    };
}
...
var List = function (_React$Component) {
    ...
    _createClass(List, [{
        ...
        value: function loadStudents() {
            ...
            fetch('http://rmit.chickenkiller.com:8080/students').then(function (res) {
                return res.json();
            }).then(function (students) {
                return _this2.props.dispatch({ type: 'FETCH_STUDENT', payload: students });
            });
        }
    }, {
        key: 'deleteStudent',
        value: function deleteStudent(studentId) {
            ...
            fetch('http://rmit.chickenkiller.com:8080/students/' + studentId, {
                method: 'delete'
            }).then(function (res) {
                return res.json();
            }).then(function (result) {
                _this3.props.dispatch({ type: 'DELETE_STUDENT', payload: studentId });
            });
        }
    }, {
        key: 'editStudent',
        value: function editStudent(id, name) {
            this.props.dispatch({ type: 'EDIT_STUDENT', payload: { id: id, name: name } });
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                this.props.students.map(function (s) {
                    return _react2.default.createElement(
                        'li',
                        { key: s._id },
                        s._id,
                        ...
                        _react2.default.createElement(
                            'button',
                            { onClick: _this4.deleteStudent.bind(_this4, s._id) },
                            'Delete'
                        ),
                        '| ',
                        _react2.default.createElement(
                            'button',
                            { onClick: _this4.editStudent.bind(_this4, s._id, s.name) },
                            'Edit'
                        )
                    );
                }),
...
var Form = function (_React$Component) {
    ...
    function Form() {
        ...
        _this.state = { studentId: '', studentName: '' };
        return _this;
    }
    ...
    _createClass(Form, [{
        ...
        value: function componentWillReceiveProps(newProps) {
            this.setState({ studentId: newProps.editStudent.id, studentName: newProps.editStudent.name });
        }
    }, {
        key: 'handleChange',
        ...
        value: function addStudent() {
            ...
            if (this.state.id === '') {
                fetch('http://rmit.chickenkiller.com:8080/students', {
                    ...
                    _this2.props.dispatch({ type: 'ADD_STUDENT', payload: student });
                });
            } else {
                fetch('http://rmit.chickenkiller.com:8080/students', {
                    headers: {
                    ...
                    method: 'put',
                    body: JSON.stringify({ _id: this.state.studentId, name: this.state.studentName })
                }).then(function (res) {
                    return res.json();
                }).then(function (student) {
                    _this2.props.dispatch({ type: 'UPDATE_STUDENT', payload: _this2.state });
                });
            }
        }
    }, {
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement('input', { type: 'text', name: 'studentId',
                    value: this.state.studentId, onChange: this.handleChange.bind(this) }),
                _react2.default.createElement('br', null),
                'Name: ',
                _react2.default.createElement('input', { type: 'text', name: 'studentName',
